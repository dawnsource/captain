...
//	private static Logger logger = Logger.getLogger(PinyinUtil.class);
	...
	public static void main(String[] args) {
		System.out.println(PinyinUtil.getFirstLetter("你"));
//		System.out.println(PinyinUtil.getFirstLetter("我爱北京天安门"));
//		System.out.println("我爱北京天安门");
//		System.out.println(PinyinUtil.getFirstLetter("I love 北京天安门"));
	}
}