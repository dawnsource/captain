 ...
 * pinyin4j是一个支持将中文转换到拼音的Java开源类库 ，pinyin4j能够根据中文字符获取其对应的拼音，而且拼音的格式可以定制。
...
public class Pinyin4jUtil {
	...
	public static void main(String[] args) {
		System.out.println(getHeadByString("支持简体中文和繁体中文字符"));
		System.out.println(stringArrayToString(getHeadByString("支持简体中文和繁体中文字符")));
		System.out.println(stringArrayToString(getHeadByString("拼音", false)));
	}
