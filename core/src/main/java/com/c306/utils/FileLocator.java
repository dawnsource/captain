...
public class FileLocator {
	...
	public URL getURL(String location) throws Exception {
		...
		try {
			...
			throw new Exception("装载配置文件错误", e);
		}
		if (url == null) {
			throw new Exception("读取配置文件为空", new Throwable("读取配置文件为空"));
		}

		return url;
	}

	public InputStream loadResource(String location) throws Exception {
