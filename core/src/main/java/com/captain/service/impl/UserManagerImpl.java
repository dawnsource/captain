...
import com.captain.dao.UserDao;
import com.captain.model.User;
import com.captain.service.UserExistsException;
import com.captain.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.captain.service.UserService")
