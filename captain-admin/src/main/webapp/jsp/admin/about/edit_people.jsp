...
<s:form cssClass="form-inline" id="appfrm" action="/admin/aboutpeople!saveOrUpdate.action" method="post" enctype="multipart/form-data">
<!-- 查询条件 -->
...
<!-- 	隐藏域 -->
  ...
  <div class="control-group">
    ...
    <div class="controls">
     ...
     <span class="help-inline">Size(pix): <code>75X70</code> </span>
	 <br/>
...
$(document).ready(function(){
	...
	$('#backbtn').click(function(event){
		$("#tab2 .Button002").button("disable");
		$('#appfrm')[0].action = '${ctx}/admin/aboutpeople!list.action';
		$('#appfrm').submit();
	});
	...
	$('#backbtn_audit').click(function(event){
		$("#tab2 .Button002").button("disable");
		$('#appfrm')[0].action = '${ctx}/admin/aboutpeople!tasklist.action';
		$('#appfrm').submit();
	});
