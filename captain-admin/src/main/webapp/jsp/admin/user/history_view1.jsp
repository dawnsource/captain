...
<s:form id="appfrm" action="/mi/order!orderProcess.action" method="post" enctype="multipart/form-data">
<!-- 查询条件 -->
...
function doCancel(){
		location = '${ctx}/mi/order!list.action?pageNo=${pageNo}&pageSize=${pageSize}';
}
